...
import com.loki.product.productServiceCustoEexception.ProductException;
...
//	private ProductEntity product;
	...
	public ProdectResponce getProductById(long id)
	{
		...
		ProductEntity productEntity = productRepository.findById(id)
				.orElseThrow(() -> new ProductException("Product with given id Not Found ","Given ID is not found"));

		ProdectResponce prodectResponce = new ProdectResponce();
		BeanUtils.copyProperties(productEntity, prodectResponce); 
		// copying the all data from entity to response it is  method
